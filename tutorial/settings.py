...
SECRET_KEY = 'django-insecure-uspj)n%=1k9v)xmap3r0^%zsfvc1*jdifj0=x@6l4jlq80i%$l'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_tutorial_rest_framework',
        'USER': 'fudo4',
        'PASSWORD': 'admin123',
        'HOST': 'localhost',
        'PORT': '5432',
...
# add setting for media
# we will use this later in snippets/urls.py
MEDIA_URL = '/media/'
